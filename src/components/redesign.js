    ...
    return (
        <Page className="portfolio" >
            ...
            <div className="portfolio-section3" >
                ...
                <p> I propose a new wirefrime design to the website. Below are 4 wireframes to the most common screens on IMDB: Main Page, Movie Page, Celebrity Page, New Page</p>
                ...
                <p>These wireframes improve on the original design through the following userbility principles.</p>
